...
export default function PatientScanPage() {
  const { addPrescription, prescriptions } = usePatients();
  ...
  const handleDrop = useCallback((e: React.DragEvent) => {
    ...
    if (!file.type.startsWith("image/")) {
      setErrorMessage("Please drop an image file (JPG, PNG, etc.)");
      setScanState("error");
      return;
    }
  ...
  const handleSave = useCallback(async () => {
    ...
    const prescription = createPrescription(ocrResult, "patient");
          ...
          <CardContent>
            ...
            {scanState === "idle" && (
              <div className="space-y-4">
                <Tabs value={inputMethod} onValueChange={(v) => setInputMethod(v as "upload" | "camera")}>
                  ...
                  <TabsContent value="upload" className="mt-4">
                    <div
                      className="rounded-xl border-2 border-dashed border-muted-foreground/25 p-8 text-center transition-colors hover:border-primary/50 cursor-pointer"
                  ...
                  <TabsContent value="camera" className="mt-4">
                    <div className="rounded-xl border-2 border-dashed border-muted-foreground/25 p-8 text-center">
                      ...
                      <p className="mb-4 text-sm text-muted-foreground">
                        Use your device camera to capture the prescription
                      </p>
            ...
            {scanState === "camera" && (
              <div className="space-y-4">
                <div className="relative overflow-hidden rounded-xl bg-black">
                  ...
                  />
                  <div className="pointer-events-none absolute inset-0 m-8 rounded-lg border-4 border-dashed border-white/30" />
                </div>
              ...
              <div className="space-y-4">
                {saveSuccess ? (
                  <div className="flex flex-col items-center justify-center py-8">
                    ...
                    <p className="font-medium text-success">Prescription saved!</p>
                  </div>
                ) : (
                  <>
            ...
            {prescriptions.length === 0 ? (
              <div className="py-8 text-center">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Upload or capture a prescription to get started
                </p>
              </div>
            ) : (
