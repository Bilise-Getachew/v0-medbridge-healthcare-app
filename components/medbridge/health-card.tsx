...
import type { Patient, ViewType } from "@/lib/types";

interface HealthCardProps {
  onNavigate: (view: ViewType) => void;
}

export function HealthCard({ onNavigate }: HealthCardProps) {
  const {
    patients,
    selectedPatient,
    setSelectedPatient,
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          {selectedPatient ? (
            <PatientDetails patient={selectedPatient} onNavigate={onNavigate} />
          ) : (
...
function PatientDetails({ patient, onNavigate }: PatientDetailsProps) {
